...
docTitle = "hearts-export" # update this for your output file name
save = True
outputDir = "exports"
autoOpen = True
debug = False

fontFam = f"fonts/Recursive_VF_1.053.ttf" # Update as needed. Easiest when font file is in same directory.
...
if save:
	...
	path = f"exports/{docTitle}-{now}.{fileFormat}"
